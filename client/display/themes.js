...
export const GLASS_FAMILIES = {
  ...
  blanc: {
    ...
    glassRim: 'rgba(255,255,255,0.95)',
    text: 'rgba(38,36,48,0.94)',
    textDim: 'rgba(38,36,48,0.48)',
    floorBody: '#2c2c34',
    floorTop: '#3c3c46',
    floorEdge: 'rgba(255,255,255,0.35)',
  },
  ...
  cream: {
    ...
    glassFill: 'rgba(255,255,255,0.9)',
    glassRim: 'rgba(255,255,255,0.95)',
    text: 'rgba(64,50,40,0.94)',
    textDim: 'rgba(64,50,40,0.48)',
    floorBody: '#40382e',
    floorTop: '#51473b',
    floorEdge: 'rgba(255,255,255,0.35)',
  },
